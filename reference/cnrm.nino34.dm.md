...
categories (fcst) of the Nino-3.4 index for January 1961-2000. The
forecast data stem from model runs initialized using data for the
preceding August 1960-1999. Definition of an "event" in the
observations: obsv \>= 27 C. Definition of the four forecast
"categories": (1) fcst \< 26 C; (2) fcst in \[26 C,27 C\[; (3) fcst in
\[27 C,28 C\[; (4) fcst \>= 28 C.
