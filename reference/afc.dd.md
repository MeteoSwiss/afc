...
- fcst:
  ...
  vector of same length as *obsv* with dichotomous forecasts (values in
  0,1)
...
This routine applies Eq.2 of Mason and Weigel (2009) to calculate the
2AFC.
