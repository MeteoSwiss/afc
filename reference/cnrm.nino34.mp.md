...
probabilistic forecasts (fcst) of the Nino-3.4 index for January
1961-2000. The forecast data stem from model runs initialized using data
for the preceding August 1960-1999. Definition of the four observation
"categories": (1) obsv \< 26 C; (2) obsv in \[26 C,27 C\[; (3) obsv in
\[27 C,28 C\[; (4) obsv \>= 28 C. The probabilistic forecasts have been
estimated by taking the fraction of ensemble members falling into each
...
- fcst:
  ...
  numeric matrix \[40 x 4\], probabilistic forecasts (fraction of
  ensemble members in each of the 4 categories)
