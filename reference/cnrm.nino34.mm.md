...
respectively forecast "categories": (1) obsv/fcst \< 26 C; (2) obsv/fcst
in \[26 C,27 C\[; (3) obsv/fcst in \[27 C,28 C\[; (4) obsv \>= 28 C.
...
- fcst:
  ...
  integer, polychotomous forecasts (categories 1-4; (1) \< 26 C; (2)
  26-27 C; (3) 27-28 C; (4) \>= 28 C)
